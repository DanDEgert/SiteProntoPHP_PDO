...
<nav class="navbar navbar-fixed-top navigation" >
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      ...
      <li><a class="btn btn-default btn-main" href="login.php" role="button">Login</a></li>
      <li><a class="btn btn-default btn-main" href="../cadastroUsuario/cadastro.php" role="button">Cadastrar</a></li>
      <li><a class="btn btn-default btn-main" href="../cadastroUsuario/consulta.php" style=background-color:null>Consultar</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div>
</nav>
       ...
       <form action="valida.php" method="post">
         <div class="col-md-6">
           <div class="form-group">
             <input type="text" class="form-control" name="loginUsuario" placeholder="Nome">
           </div>
           <div class="form-group margin-0">
             <input type="text" class="form-control" id="senha" name="senhaUsuario" placeholder="Senha">
           </div>
         </div>
         </div> <br>
         <div class="col-md-12">
           <div class="contact-btn text-center">
             <input class="btn btn-default btn-main" type="submit" value="Entrar">
           </div>
         </div>
       </form>
     </div>
