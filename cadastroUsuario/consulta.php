...
<section class="page-header services-header" data-parallax="scroll" data-image-src="../images/header/contact-folding-img.jpg">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1 class="text-center">Relação de Usuários</h1>
      </div>
    </div>
  </div>
</section>
      ...
      if (isset($registros)) {
        foreach ($registros as $linha) { 
          ...
          echo '<tr>
              ...
              <td>'.$linha['nome'].'</td>
              <td>'.$linha['senha'].'</td>
  <td> <a href=excluir.php?id='.$linha['id'].' class="btn btn-danger">Excluir</a> &emsp;
       <a href=FormularioAlteracao.php?id='.$linha['id'].' class="btn btn-primary">Alterar</a></td>
             </tr>';
      ...
      <a href="cadastro.php" class="btn btn-default btn-main">
        Incluir</a>
      
      <a href="../login/login.php" class="btn btn-default btn-main">
        Voltar</a>
    </div>
           </div>
         </div>
